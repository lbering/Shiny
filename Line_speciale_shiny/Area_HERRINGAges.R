...
øresund_data <- read_csv("areas/øresund_data.csv")#udtræk fra GIS
...
kattegatnord_data <- read_csv("areas/kattegatnord_data.csv")#udtræk fra GIS
...
kattegatmidt_data <- read_csv("areas/kattegatmidt_data.csv")#udtræk fra GIS
...
kattegatsyd_data <- read_csv("areas/kattegatsyd_data.csv")#udtræk fra GIS
...
storebælt_data <- read_csv("areas/storebælt_data.csv")#udtræk fra GIS
...
femeren_data <- read_csv("areas/femeren_data.csv")#udtræk fra GIS
...
østersøen_data <- read_csv("areas/østersøen_data.csv")#udtræk fra GIS
...
save(dat_herring,file="Areas_herring_combined.Rdata")
write.csv(dat_herring,"GAM/dat_herring.csv")
