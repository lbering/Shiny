...
mikael <- FALSE
line<- TRUE
if(mikael) setwd("C:/Users/mvde/Desktop/Lines_App/Line_speciale_shiny/Shiny_fiskepleje")
if(line) setwd("~/Documents/DTU/Speciale/R/shiny/Shiny_fiskepleje")
